...
(function ($, Drupal, drupalSettings, once) {
  ...
  * digital Accordion.
   */
  Drupal.behaviors.digitalAccordion = {
  ...
  * YTPlayer.
  */
  Drupal.behaviors.digitalYTPlayer = {
    attach: function attach(context, settings) {
  ...
  * Megamenu.
  */
  Drupal.behaviors.digitalMegaMenu = {
    attach: function attach(context, settings) {
